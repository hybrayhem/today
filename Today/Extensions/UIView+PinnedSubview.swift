...
extension UIView {
    func addPinnedSubview(
        ...
        subview.translatesAutoresizingMaskIntoConstraints = false // prevent system from creating automatic constraints
        
        // Pin subview to inside of view with given insets(paddings)
